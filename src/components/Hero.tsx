...
const Hero = () => {
  ...
  return <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-1/4 right-1/3 w-96 h-96 rounded-full bg-tenbeo/10 animate-pulse-slow" style={{
        animationDelay: '1s'
      }}></div>
      </div>
      ...
      <div className="container relative z-10 flex flex-col items-center px-4 md:px-8">
        ...
        <div className="w-full max-w-2xl aspect-square relative mb-16">
          ...
          <img src="/lovable-uploads/4ae18c97-f220-4a36-82c7-34d563cfb97b.png" alt="Calabeo Heartbeat Visualization" className="w-full h-full object-contain animate-float" />
        </div>
